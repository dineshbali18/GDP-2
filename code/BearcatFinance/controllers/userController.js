  ...
  const loginUser = async (req, res) => {
    ...
    try {
      ...
      if (user && await user.validatePassword(password)) {
        const otpApiResponse = await axios.post('http://18.117.93.67:3000/api/user/generateotp', { email: user.email });
        ...
        const sendOtpResponse = await axios.post('http://18.117.93.67:3000/api/user/sendotp', { email: user.email });
