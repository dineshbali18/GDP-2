  ...
  const registerUser = async (req, res) => {
    ...
    try {
      ...
      if (user.UserID !== undefined) {
        const otpApiResponse = await axios.post('http://10.10.104.248:3000/api/user/generateotp', { email });
        ...
        const sendOtpResponse = await axios.post('http://10.10.104.248:3000/api/user/sendotp', { email });
  ...
  const loginUser = async (req, res) => {
    ...
    try {
      ...
      if (user && await user.validatePassword(password)) {
        const otpApiResponse = await axios.post('http://10.10.104.248:3000/api/user/generateotp', { email: user.email });
        ...
        const sendOtpResponse = await axios.post('http://10.10.104.248:3000/api/user/sendotp', { email: user.email });
